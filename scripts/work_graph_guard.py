...
PROTECTED_ASSET_SHA256 = {
    ...
    "scripts/test_work_graph_guard.py": frozenset(
        {
            "c04aec6c8ba7930ff772e1030c5737e8f86ecbe59afdf4a3078e1271fec41992",
        }
    ),
}
    ...
    while index < len(text):
        ...
        if quote:
            ...
            if char == "\n":
                ...
                escaped = False
        elif char in {"'", '"'} and (index == 0 or text[index - 1].isspace() or text[index - 1] in ":[{,?-"):
            quote = char
            result.append(" ")
