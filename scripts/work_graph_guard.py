...
PROTECTED_ASSET_SHA256 = {
    ".github/workflows/work-graph-guard.yml": frozenset(
        {
            "76ed1dbd48ddacf4164f01b9b890e21bef2ca28e41a2010ce4cf3c2015a8456d",
    ...
    ".github/workflows/work-graph-guard-tests.yml": frozenset(
        {
            ...
            "fbf109db5af00b239ac8ccea6bab3a512391a7ab87b754121a4ca00c489947e5",
        }
    ),
    "scripts/test_work_graph_guard.py": frozenset(
        {
            "7c2a4b8f477ce357d13ab3867553ab6281c30095d8f64304483fd78f1d1bd776",
