...
- `controlled/`: one machine-readable requirements, design, and verification chain with stable identities;
...
2. Write the problem statement and acceptance criteria in `controlled/requirements.yaml`.
3. Add only design identities that refine those requirements, then connect verification obligations.
